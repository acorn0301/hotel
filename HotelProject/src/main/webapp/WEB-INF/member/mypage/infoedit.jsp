   ...
   <div style="text-align:center;">
      <div class="profile_photo">
         ...
         <div class="photo_delete_div">      
            ...
            <input type="hidden" name="isPicDel" value="0" id="isPicDel"> 
         </div>
      ...
      <script type="text/javascript">
         $("#inputImage").change(function(){ // 이미지 미리보기
          ...
          $("#btnDelete").click(function(){ // 이미지 미리보기삭제
            //alert("이미지 삭제");
            $(".select_img img").attr("src", "<%=root%>/save/member_pic/user.svg");
