...
<body>
	<div class="admin_body">
		<div class="headTit">
			<h2 class="tit">주문내역 상세보기</h2>
		</div>

	
	<div class="dashboard_div">
	<div class="dashboard_div_div">
...
<%-- 			
		...
		<div class="btncenter">
			<input type="button" id="myroomslist" value="목록가기" onclick="history.back()">
			<input type="submit" id="myroomsCancel" value="주문취소" onclick="myorderCancel()">
		</div><br>
		<script type="text/javascript">
			...
			function myorderCancel(){
				...
				if(chk){
					location.href="m_OrderCancelOne.do?order_num=" + ${aodto.order_num} + "&room_status=" + ${aodto.room_status};
				}			
			}
		</script>
