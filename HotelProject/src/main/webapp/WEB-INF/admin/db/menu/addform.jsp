...
<div class="dashboard_div">
	...
	<form action="adminMenuAdd.do" method="post" enctype="multipart/form-data">
	...
	<div class="dashboard_div_table">
		<table class="bookdetail_table">
			...
			<tr class="bookdetail_table_tr">
				...
				<td class="bookdetail_table_td td_for_selectbox">
					<input type="text" name="menu_name_kor" class="inputbox" id="menu_name_kor" title="메뉴명(국문)"  value="" required="required">				
				</td>	
			</tr>
			...
			<tr class="bookdetail_table_tr">
				...
				<td class="bookdetail_table_td td_for_selectbox">
					<input type="text" name="menu_name_eng" class="inputbox" id="menu_name_eng" title="메뉴명(한글)"  value="" required="required">				
				</td>	
			</tr>
			...
			<tr class="bookdetail_table_tr">
				...
				<td class="bookdetail_table_td td_for_selectbox">
					<input type="text" name="menu_price" class="inputbox" id="menu_price" title="메뉴가격"  value="" required="required">				
				</td>	
			</tr>
			...
			<tr class="bookdetail_table_tr">
				...
				<td class="bookdetail_table_td td_for_textarea">
					<textarea id="menu_desc" name="menu_desc" class="write_textarea admin_textarea" rows="1" cols="10" >&nbsp;</textarea>				
				</td>	
			</tr>
			
			<tr class="bookdetail_table_tr">
				<td class="bookdetail_table_th bookdetail_table_td">메뉴사진</td>
				<td class="bookdetail_table_td td_for_selectbox">
					<input id="upfile" type="file" name="upfile" class="form-control myfileinput" required="required">	
				</td>	
			</tr>
			
			<tr class="bookdetail_table_tr">
				<td class="bookdetail_table_th bookdetail_table_td">미리보기</td>
				<td class="bookdetail_table_td td_for_selectbox">
					<div class="select_img"><img src="images/menu/noimg.jpg" width="100%"></div>
				</td>	
			</tr>
