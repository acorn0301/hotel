...
<!-- 소개 -->
<img class="imgallwidth mySlides w3-animate-left"    src="images/room/standard/9.jpg">
<img class="imgallwidth mySlides w3-animate-left" src="images/room/standard/10.jpg">
<img class="imgallwidth mySlides w3-animate-left"    src="images/room/standard/11.jpg">
<img class="imgallwidth mySlides w3-animate-left" src="images/room/standard/13.jpg">

<div class="room_st">
9~15층에 위치한 스탠다드룸은 편안함과 쾌적함이 인상적인 최상의 휴식 환경을 제공합니다.<br>
모던한 아름다움과 1st호텔 수준의 고급 침구 및 침대 그리고 고급 어메니티로 한 단계 업그레이드 된 휴식을 경험하십시오.
<br>
</div>
<div class="room_div">
<span class="room_span">· 위치</span>&nbsp;&nbsp;&nbsp;9~15층 <br>
<span class="room_span">· 전망</span>&nbsp;&nbsp;&nbsp;시티 뷰 <br>
<span class="room_span">· 침대</span>&nbsp;&nbsp;&nbsp;더블, 트윈, 패밀리 트윈 <br>
