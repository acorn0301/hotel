...
<img class="imgallwidth mySlides w3-animate-left"  alt="그랜드룸이미지"  src="images/room/grand/17.jpg">
<img class="imgallwidth mySlides w3-animate-left" alt="그랜드룸이미지" src="images/room/grand/21.jpg">

<div class="room_st">
15~17층에 위치한 그랜드룸은 심플하고 모던한 디자인이 돋보이는 넓은 공간을 자랑합니다.<br>
모던한 아름다움과 신라호텔 수준의 고급 침구 및 침대 그리고 고급 어메니티로 한 단계 업그레이드 된 휴식을 경험하십시오.
<br>
</div>
<div class="room_div">
<span class="room_span">· 위치</span>&nbsp;&nbsp;&nbsp;15~17층 <br>
<span class="room_span">· 전망</span>&nbsp;&nbsp;&nbsp;시티 뷰 <br>
<span class="room_span">· 침대</span>&nbsp;&nbsp;&nbsp;더블<br>
<span class="room_span">· 크기</span>&nbsp;&nbsp;&nbsp;44.8㎡ <br>
<span class="room_span_1">· 룸구성</span>&nbsp;&nbsp;침실 1, 라운지 룸 1, 욕실 1 <br>
